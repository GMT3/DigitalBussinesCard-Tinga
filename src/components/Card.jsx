  ...
  return (
    <>
      ...
      >
        <img
          src={IMG}
          className="w-24 h-24 rounded-full mx-auto mt-5 bg-slate-100"
        ></img>
        <h1 className="text-slate-800 text-lg font-thin uppercase mt-1 mx-auto">
          Software Developer
        </h1>
        <h2 className=" text-slate-800 text-sm font-semibold uppercase mx-auto">
          Tinga Warren Chingeni
        </h2>

        <div className="flex gap-3 justify-start ml-5 mt-2">
          <svg
